...
contract MyEpicNFT is ERC721URIStorage {
    ...
    string[] secondWords = ["Dog", "Cat", "Pig", "Bird", "Dragon", "Tiger"];
    string[] thirdWords = ["Yellow", "Red", "Green", "Blue", "Cyan", "Black"];
    ...
    function getTotalNFTs() public view returns (uint256) {
        console.log("We have %d total NFTs!", totalNFTs);
        return totalNFTs;
    }
    ...
    function makeAnEpicNFT() public {
        ...
        // require(totalNFTs <= 1, "Maximum number of NFTs reached");
